...
type WorkloadPlanSpec struct {
	...
	// foo is an example field of WorkloadPlan. Edit workloadplan_types.go to remove/update
	// +optional
...
type WorkloadPlanStatus struct {
	...
	// conditions represent the current state of the WorkloadPlan resource.
...
type WorkloadPlan struct {
	...
	// spec defines the desired state of WorkloadPlan
	// +required
	Spec WorkloadPlanSpec `json:"spec"`

	// status defines the observed state of WorkloadPlan
	// +optional
	Status WorkloadPlanStatus `json:"status,omitempty,omitzero"`
}
